...
import com.jeyix.school_jeyix.core.security.handler.OAuth2FailureHandler;
import com.jeyix.school_jeyix.core.security.handler.OAuth2SuccessHandler;
import com.jeyix.school_jeyix.core.security.jwt.JwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/users/**").hasAnyRole("PARENT", "ADMIN")
